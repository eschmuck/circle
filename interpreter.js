...
var COMMAND_LIST = [
          ...
          { command: "beg"      , minimumPosition: Character.POS_RESTING,  functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BEG },
          { command: "bleed"    , minimumPosition: Character.POS_RESTING,  functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BLEED },
          { command: "blush"    , minimumPosition: Character.POS_RESTING,  functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BLUSH },
          { command: "bounce"   , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BOUNCE },
          { command: "bow"      , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BOW },
          { command: "brb"      , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BRB },
          { command: "burp"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_BURP },
          
          { command: "cackle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CACKLE },
          { command: "chuckle"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CHUCKLE },
          { command: "clap"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CLAP },
          { command: "comb"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_COMB },
          { command: "comfort"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_COMFORT },
          { command: "cough"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_COUGH },
          { command: "cringe"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CRINGE },
          { command: "cry"      , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CRY },
          { command: "cuddle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CUDDLE },
          { command: "curse"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CURSE },
          { command: "curtsey"  , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_CURTSEY },
          
          { command: "dance"    , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_DANCE },
          { command: "daydream" , minimumPosition: Character.POS_SLEEPING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_DAYDREAM },
          { command: "drool"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_DROOL },

          { command: "embrace"  , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_EMBRACE },

          { command: "fart"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FART },
          { command: "flip"     , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FLIP },
          { command: "flirt"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FLIRT },
          { command: "fondle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FONDLE },
          { command: "french"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FRENCH },
          { command: "frown"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FROWN },
          { command: "fume"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_FUME },

          { command: "gasp"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GASP },
          { command: "giggle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GIGGLE },
          { command: "glare"    , minimumPosition: Character.POS_RESTING,  functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GLARE },
          { command: "greet"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GREET },
          { command: "grin"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GRIN },
          { command: "groan"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GROAN },
          { command: "grope"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GROPE },
          { command: "grovel"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GROVEL },
          { command: "growl"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_GROWL },

          { command: "hiccup"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_HICCUP },
          { command: "hug"      , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_HUG },

          { command: "kiss"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_KISS },

          { command: "laugh"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_LAUGH },
          { command: "lick"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_LICK },
          { command: "love"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_LOVE },

          { command: "massage"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_MASSAGE },
          { command: "moan"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_MOAN },

          { command: "nibble"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_NIBBLE },
          { command: "nod"      , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_NOD },
          { command: "nudge"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_NUDGE },
          { command: "nuzzle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_NUZZLE },

          { command: "pat"      , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PAT },
          { command: "peer"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PEER },
          { command: "point"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_POINT },
          { command: "poke"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_POKE },
          { command: "ponder"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PONDER },
          { command: "pout"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_POUT },
          { command: "pray"     , minimumPosition: Character.POS_SITTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PRAY },
          { command: "puke"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PUKE },
          { command: "punch"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PUNCH },
          { command: "purr"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_PURR },

          { command: "roll"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_ROLL },
          { command: "ruffle"   , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_RUFFLE },
          ...
          { command: "scream"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SCREAM },
          { command: "shake"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SHAKE },
          { command: "shiver"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SHIVER },
          { command: "sigh"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SIGH },
          { command: "shrug"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SHRUG },
          { command: "sing"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SING },
          { command: "slap"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SLAP },
          { command: "smile"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SMILE },
          { command: "smirk"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SMIRK },
          { command: "snap"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNAP },
          { command: "snarl"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNARL },
          { command: "sneeze"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNEEZE },
          { command: "snicker"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNICKER },
          { command: "sniff"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNIFF },
          { command: "snore"    , minimumPosition: Character.POS_SLEEPING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNORE },
          { command: "snowball" , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNOWBALL },
          { command: "snuggle"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SNUGGLE },
          { command: "spank"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SPANK },
          { command: "spit"     , minimumPosition: Character.POS_SITTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SPIT },
          { command: "stare"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_STARE },
          { command: "steam"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_STEAM },
          { command: "stroke"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_STROKE },
          { command: "strut"    , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_STRUT},
          { command: "sulk"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_SULK },

          { command: "tackle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_TACKLE },
          { command: "tango"    , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_TANGO },
          { command: "taunt"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_TAUNT },
          { command: "thank"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_THANK },
          { command: "think"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_THINK },
          { command: "tickle"   , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_TICKLE },
          { command: "twiddle"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_TWIDDLE },

          { command: "wave"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_WAVE },
          { command: "whine"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_WHINE },
          { command: "whistle"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_WHISTLE },
          { command: "wiggle"   , minimumPosition: Character.POS_STANDING, functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_WIGGLE},
          { command: "wink"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_WINK},
          { command: "worship"  , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_WORSHIP },

          { command: "yawn"     , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_YAWN },
          { command: "yodel"    , minimumPosition: Character.POS_RESTING , functionPointer: do_action     , minimumLevel: 0, subCommand: Character.SCMD_YODEL },
    ];
